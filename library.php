...
<br/>&nbsp;
<nav>
  <div style="text-align: center; color: forestgreen; font-family: sans-serif">
 
  	<h1>Check Books to request</h1>
<img src="images/read.jpg" height="250" width="550" alt="Reads in Library">

<br/><br/>

<nav style="background-color: orange; margin-left:200px; margin-right: 200px; text-align: left; padding-left:200px">
<br/>
<form method="post" action="lib.php">
	Id No.
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<input style="padding-left: 10px" type="number" name="idno" required><br/>
	<br/>
	Book ISBN No&nbsp;<input style="padding-left: 10px" type="number" name="isbno" required><br/>
	<br/>
	Course
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<select name="course">
	...
	<input type="submit" name="submit" value="Request This Book">
</form>
...
<br/>
  ...
  <a href="verify.php">Check if the details passed are okay before you receive the book</a>
</nav>
