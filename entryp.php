...
<nav>
  <div style="text-align: center; color: forestgreen; font-family: sans-serif">
  	...
  	<h1>Proceed to Library</h1>
  	<img src="images/lib.jpg" height="250" width="550" alt="library">
  	<a href="library.php">Go To Library</a>
  	<h1>Proceed to Academics</h1>
  	<img src="images/Academic.jpg" height="250" width="550" alt="library">
  	<a href="Academics.php">Update your details</a>
